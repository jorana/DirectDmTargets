...
# parser.add_argument('-sampler', str, default = 'multinest'., help="sampler (multinest or nestle)")
...
# parser.add_argument('-nlive', type=int, default=1024, help="live points used by nestle")
...
#     help="Set to 0 (no print statements), 1 (some print statements) or >1 (a lot of "
#          "print statements). Set the level of print statements while fitting.")
